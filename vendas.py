...
def main():
    ...
    url_template = "https://api.userede.com.br/redelabs/merchant-statement/v1/sales"
    ...
    for companyNumber in companyNumbers:
        params = {
            "startDate": manual_startdate,
            "endDate": manual_enddate,
        ...
        response = requests.get(url_template, params=params, headers=headers)
            ...
            if new_access_token:
                ...
                if response.status_code == 200:
                    ...
                    for transaction in transactions:
                        ...
                        print(f"Transação adicionada para a empresa {companyNumber}: {transaction}")
        else:
